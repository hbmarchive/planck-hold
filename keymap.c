...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE_LAYER] = LAYOUT_planck_grid(
    ...
    LCTL(KC_R),     OSM(MOD_LCTL),  OSM(MOD_LALT),  OSM(MOD_LGUI),         OSM(MOD_LSFT),         KC_SPC,  KC_ENT,  KC_UP, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
  ),
  ...
  [NUM_LAYER] = LAYOUT_planck_grid(
    KC_TRNS,  KC_PAST,  KC_1,     KC_2,     KC_3,     KC_PPLS,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_BSPC,
